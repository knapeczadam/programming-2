...
std::string DaeRectLabel::ToString() const
{
    ...
    properties += "<DaeRectLabel\n";
    properties += PropertiesToString();
    properties += "  Label=\"" + m_Label + "\"\n";
    properties += "  TextColor=\"" + std::to_string(m_TextColor.r) + ',' + std::to_string(m_TextColor.g) + ',' + std::to_string(m_TextColor.b) + ',' + std::to_string(m_TextColor.a) +
        "\"\n";
    properties += "/>\n";
    return properties;
}
