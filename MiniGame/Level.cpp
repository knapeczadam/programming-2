...
#if DEBUG_SPRITE_BOUNDARIES
    utils::DrawRect(m_FenceBottomLeft.x, m_FenceBottomLeft.y, m_pFenceTexture->GetWidth(), m_pFenceTexture->GetHeight());
...
{
    SVGParser::GetVerticesFromSvgFile("Images/level1.svg", m_Vertices);
}
